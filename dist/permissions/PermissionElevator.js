export class PermissionElevator {
    ...
    permissionPatterns = new Map();
    learningData = new Map();
    constructor(credentialManager, roleManager, configManager) {
     ...
     */
    async elevatePermissions(context) {
     ...
     */
    async tryRoleAssumption(context) {
        try {
     ...
     */
    async tryGracefulDegradation(context) {
     ...
     */
    async tryFallbackStrategy(strategy, context) {
        switch (strategy) {
     ...
     */
    async tryReadOnlyValidation(context) {
        try {
     ...
     */
    async requestManualApproval(context) {
     ...
     */
    async tryStagedDeployment(context) {
        try {
     ...
     */
    async createPermissionRequest(context) {
     ...
     */
    learnFromSuccess(context, method) {
...
//# sourceMappingURL=PermissionElevator.js.map